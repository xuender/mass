...
type Config struct {
	...
	Dsn map[string]string `protobuf:"bytes,1,rep,name=dsn,proto3" json:"dsn,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Config) GetDsn() map[string]string {
	if x != nil {
		return x.Dsn
	}
	return nil
...
var file_pb_config_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x67, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	0x25, 0x0a, 0x03, 0x64, 0x73, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x70,
	0x62, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x44, 0x73, 0x6e, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x52, 0x03, 0x64, 0x73, 0x6e, 0x1a, 0x36, 0x0a, 0x08, 0x44, 0x73, 0x6e, 0x45, 0x6e, 0x74,
...
var file_pb_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pb_config_proto_goTypes = []interface{}{
	(*Config)(nil), // 0: pb.Config
	nil,            // 1: pb.Config.DsnEntry
}
var file_pb_config_proto_depIdxs = []int32{
	1, // 0: pb.Config.dsn:type_name -> pb.Config.DsnEntry
